...
_AUTO_CLEAR = [
    ...
    '저장됩니다', '저장된다', '생성됩니다', '생성된다',
    '반영됩니다', '반영된다', '해제됩니다', '해제된다',
    '설정됩니다', '설정된다', '노출됩니다', '노출된다',
    '확인됩니다', '확인된다', '적용됩니다', '적용된다',
    '실행됩니다', '실행된다', '진입됩니다', '진입된다',
    '랜딩됩니다', '랜딩된다', '닫힙니다', '닫힌다',
    '초기화됩니다', '초기화된다', '취소됩니다', '취소된다',
    # 명사형 축약 (됨) — 결론적 표현으로 PASS 판단 가능
    '이동됨', '표시됨', '노출됨', '활성화됨', '비활성화됨',
    '전환됨', '추가됨', '삭제됨', '변경됨', '완료됨',
    '저장됨', '생성됨', '반영됨', '해제됨', '설정됨',
    '확인됨', '적용됨', '실행됨', '진입됨', '랜딩됨',
    '닫힘', '초기화됨', '취소됨', '수행됨', '처리됨',
    '전송됨', '수신됨', '업데이트됨', '동기화됨', '연결됨',
]
...
# 기대결과 명사형 → 문장형
# 패턴: '됨' 으로 끝나는 단어를 '된다.'로 변환 (줄 끝 또는 문장 끝)
_EXP_ENDINGS = [
    (re.compile(r'표시됨(?=[.\s\n]|$)'),       '표시된다.'),
    (re.compile(r'노출됨(?=[.\s\n]|$)'),        '노출된다.'),
    (re.compile(r'이동됨(?=[.\s\n]|$)'),        '이동된다.'),
